...
namespace Telegram.Bot.Requests
{
    ...
    {
        /// <summary>
        /// Identifier of the first update to be returned. Must be greater by one than the highest among the identifiers of previously received updates. By default, updates starting with the earliest unconfirmed update are returned. An update is considered confirmed as soon as <see cref="GetUpdatesRequest"/> is called with an <see cref="Offset"/> higher than its <see cref="Update.Id"/>. The negative offset can be specified to retrieve updates starting from <see cref="Offset">-offset</see> update from the end of the updates queue. All previous updates will forgotten.
        /// </summary>
