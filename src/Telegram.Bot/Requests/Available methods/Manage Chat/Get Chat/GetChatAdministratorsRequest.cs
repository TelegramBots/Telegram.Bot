...
/// <summary>
/// Use this method to get a list of administrators in a chat, which aren't bots.<para>Returns: An Array of <see cref="ChatMember"/> objects.</para>
/// </summary>
public partial class GetChatAdministratorsRequest : RequestBase<ChatMember[]>, IChatTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="GetChatAdministratorsRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="GetChatAdministratorsRequest"/>
    /// </summary>
