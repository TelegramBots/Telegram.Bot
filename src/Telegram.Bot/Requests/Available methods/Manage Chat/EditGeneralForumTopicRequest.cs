...
/// <summary>
/// Use this method to edit the name of the 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have <em>CanManageTopics</em> administrator rights.<para>Returns: </para>
/// </summary>
public partial class EditGeneralForumTopicRequest : RequestBase<bool>, IChatTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="EditGeneralForumTopicRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="EditGeneralForumTopicRequest"/>
    /// </summary>
