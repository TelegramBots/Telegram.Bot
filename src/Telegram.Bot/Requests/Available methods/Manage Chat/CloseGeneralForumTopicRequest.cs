...
/// <summary>
/// Use this method to close an open 'General' topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights.<para>Returns: </para>
/// </summary>
public partial class CloseGeneralForumTopicRequest : RequestBase<bool>, IChatTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="CloseGeneralForumTopicRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="CloseGeneralForumTopicRequest"/>
    /// </summary>
