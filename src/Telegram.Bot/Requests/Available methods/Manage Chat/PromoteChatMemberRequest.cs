...
public class PromoteChatMemberRequest : RequestBase<bool>, IChatTargetable, IUserTargetable
{
    ...
    /// <summary>
    /// Pass <c>true</c>, if the administrator's presence in the chat is hidden
    /// </summary>
    [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
    public bool? IsAnonymous { get; set; }

    /// <summary>
    /// Pass <c>true</c>, if the administrator can access the chat event log, chat statistics, message
    ...
    /// <summary>
    /// Pass <c>true</c>, if the administrator can manage voice chats
    /// </summary>
    ...
    /// <summary>
    /// Pass <c>true</c>, if the administrator can add new administrators with a subset of their own
    ...
    /// <summary>
    /// Pass <c>true</c> if the user is allowed to create, rename, close, and reopen forum topics, supergroups only
    /// </summary>
    [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
