...
/// <summary>
/// Use this method to set a new profile photo for the chat. Photos can't be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate administrator rights.<para>Returns: </para>
/// </summary>
public partial class SetChatPhotoRequest : FileRequestBase<bool>, IChatTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="SetChatPhotoRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="SetChatPhotoRequest"/>
    /// </summary>
