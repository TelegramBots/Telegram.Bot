...
/// <summary>
/// Use this method to close an open topic in a forum supergroup chat. The bot must be an administrator in the chat for this to work and must have the <em>CanManageTopics</em> administrator rights, unless it is the creator of the topic.<para>Returns: </para>
/// </summary>
public partial class CloseForumTopicRequest : RequestBase<bool>, IChatTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="CloseForumTopicRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="CloseForumTopicRequest"/>
    /// </summary>
