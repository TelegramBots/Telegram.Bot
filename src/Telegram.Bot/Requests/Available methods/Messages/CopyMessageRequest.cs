...
{
    /// <summary>
    /// Use this method to copy messages of any kind. Service messages and invoice messages can't be copied. The method is analogous to the method <see cref="ForwardMessageRequest"/>, but the copied message doesn't have a link to the original message. Returns the <see cref="Types.MessageId"/> of the sent message on success.
    /// </summary>
