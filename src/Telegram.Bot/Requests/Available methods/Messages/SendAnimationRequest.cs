...
namespace Telegram.Bot.Requests
{
                                        ...
                                        ICaptionEntities
    {
        ...
        /// <summary>
        /// Animation to send. Pass a <see cref="InputTelegramFile.FileId"/> as String to send an animation that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an animation from the Internet, or upload a new animation using multipart/form-data
        /// </summary>
        [JsonProperty(Required = Required.Always)]
        ...
        /// <summary>
        /// Animation caption (may also be used when resending animation by <see cref="InputTelegramFile.FileId"/>), 0-1024 characters after entities parsing
        /// </summary>
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
