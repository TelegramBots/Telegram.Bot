...
/// <summary>
/// Use this method to send animation files (GIF or H.264/MPEG-4 AVC video without sound).<para>Returns: The sent <see cref="Message"/> is returned.</para>
/// </summary>
/// <remarks>
...
public partial class SendAnimationRequest : FileRequestBase<Message>, IChatTargetable, IBusinessConnectable
{
    ...
    /// <summary>
    /// Animation to send. Pass a FileId as String to send an animation that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get an animation from the Internet, or upload a new animation using <see cref="InputFileStream"/>. <a href="https://core.telegram.org/bots/api#sending-files">More information on Sending Files »</a>
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
    ...
    /// <summary>
    /// Animation caption (may also be used when resending animation by <em>FileId</em>), 0-1024 characters after entities parsing
    /// </summary>
    [JsonInclude]
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    /// <summary>
    /// Initializes an instance of <see cref="SendAnimationRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="SendAnimationRequest"/>
    /// </summary>
