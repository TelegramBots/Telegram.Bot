...
/// <summary>
/// Use this method to change the chosen reactions on a message. Service messages can't be reacted to. Automatically forwarded messages from a channel to its discussion group have the same available reactions as messages in the channel.<para>Returns: </para>
/// </summary>
public partial class SetMessageReactionRequest : RequestBase<bool>, IChatTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="SetMessageReactionRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="SetMessageReactionRequest"/>
    /// </summary>
