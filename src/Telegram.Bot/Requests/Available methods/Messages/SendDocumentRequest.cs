...
namespace Telegram.Bot.Requests
{
                                       ...
                                       ICaptionEntities
    {
        ...
        /// <summary>
        /// File to send. Pass a <see cref="InputTelegramFile.FileId"/> as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data
        /// </summary>
        [JsonProperty(Required = Required.Always)]
