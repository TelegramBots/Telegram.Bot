...
public partial class CopyMessagesRequest : RequestBase<MessageId[]>, IChatTargetable
{
    ...
    /// <summary>
    /// A list of 1-100 identifiers of messages in the chat <see cref="FromChatId">FromChatId</see> to copy. The identifiers must be specified in a strictly increasing order.
    /// </summary>
    [JsonRequired]
    [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
    ...
    /// <summary>
    /// Initializes an instance of <see cref="CopyMessagesRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="CopyMessagesRequest"/>
    /// </summary>
