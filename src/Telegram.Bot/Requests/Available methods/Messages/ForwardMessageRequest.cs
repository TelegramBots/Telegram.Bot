...
/// <summary>
/// Use this method to forward messages of any kind. Service messages and messages with protected content can't be forwarded.<para>Returns: The sent <see cref="Message"/> is returned.</para>
/// </summary>
public partial class ForwardMessageRequest : RequestBase<Message>, IChatTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="ForwardMessageRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="ForwardMessageRequest"/>
    /// </summary>
