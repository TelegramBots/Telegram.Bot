...
/// <summary>
/// Use this method to get information about the connection of the bot with a business account.<para>Returns: A <see cref="BusinessConnection"/> object on success.</para>
/// </summary>
public partial class GetBusinessConnectionRequest : RequestBase<BusinessConnection>, IBusinessConnectable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="GetBusinessConnectionRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="GetBusinessConnectionRequest"/>
    /// </summary>
