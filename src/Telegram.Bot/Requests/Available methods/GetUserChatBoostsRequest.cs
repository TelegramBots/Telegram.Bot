...
/// <summary>
/// Use this method to get the list of boosts added to a chat by a user. Requires administrator rights in the chat.<para>Returns: A <see cref="UserChatBoosts"/> object.</para>
/// </summary>
public partial class GetUserChatBoostsRequest : RequestBase<UserChatBoosts>, IChatTargetable, IUserTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="GetUserChatBoostsRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="GetUserChatBoostsRequest"/>
    /// </summary>
