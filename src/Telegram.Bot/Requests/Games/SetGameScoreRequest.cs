...
/// <summary>
/// Use this method to set the score of the specified user in a game message.<para>Returns: The <see cref="Message"/> is returned</para>
/// </summary>
/// <remarks>
...
public partial class SetGameScoreRequest : RequestBase<Message>, IChatTargetable, IUserTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="SetGameScoreRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="SetGameScoreRequest"/>
    /// </summary>
