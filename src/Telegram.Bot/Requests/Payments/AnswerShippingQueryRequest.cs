...
/// <summary>
/// If you sent an invoice requesting a shipping address and the parameter <em>IsFlexible</em> was specified, the Bot API will send an <see cref="Update"/> with a <em>ShippingQuery</em> field to the bot. Use this method to reply to shipping queries<para>Returns: </para>
/// </summary>
public partial class AnswerShippingQueryRequest : RequestBase<bool>
{
    ...
    /// <summary>
    /// A array of available shipping options.
    /// </summary>
    [JsonInclude]
    ...
    /// <summary>
    /// Initializes an instance of <see cref="AnswerShippingQueryRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="AnswerShippingQueryRequest"/>
    /// </summary>
