...
public partial class EditMessageTextRequest() : FileRequestBase<Message>("editMessageText"), IChatTargetable, IBusinessConnectable
{
    ...
    /// <summary>New rich content of the message; required if <see cref="Text">Text</see> isn't specified. Direct upload of new files and explicit upload of files by a URL isn't supported when an inline message is edited.</summary>
