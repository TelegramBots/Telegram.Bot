...
/// <summary>
/// Use this method to change search keywords assigned to a regular or custom emoji sticker. The sticker must belong to a sticker set created by the bot.<para>Returns: </para>
/// </summary>
public partial class SetStickerKeywordsRequest : RequestBase<bool>
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="SetStickerKeywordsRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="SetStickerKeywordsRequest"/>
    /// </summary>
