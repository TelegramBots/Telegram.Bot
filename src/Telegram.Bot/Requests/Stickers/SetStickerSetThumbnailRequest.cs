...
/// <summary>
/// Use this method to set the thumbnail of a regular or mask sticker set. The format of the thumbnail file must match the format of the stickers in the set.<para>Returns: </para>
/// </summary>
public partial class SetStickerSetThumbnailRequest : FileRequestBase<bool>, IUserTargetable
{
    ...
    /// <summary>
    /// Initializes an instance of <see cref="SetStickerSetThumbnailRequest"/>
    /// </summary>
    ...
    /// <summary>
    /// Instantiates a new <see cref="SetStickerSetThumbnailRequest"/>
    /// </summary>
