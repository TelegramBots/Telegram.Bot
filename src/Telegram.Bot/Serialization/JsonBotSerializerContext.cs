...
[JsonSerializable(typeof(SendLivePhotoRequest))]
...
[JsonSerializable(typeof(AnswerChatJoinRequestQueryRequest))]
[JsonSerializable(typeof(SendChatJoinRequestWebAppRequest))]
...
[JsonSerializable(typeof(GetUserPersonalChatMessagesRequest))]
...
[JsonSerializable(typeof(AnswerGuestQueryRequest))]
...
[JsonSerializable(typeof(GetManagedBotAccessSettingsRequest))]
[JsonSerializable(typeof(SetManagedBotAccessSettingsRequest))]
...
[JsonSerializable(typeof(EditEphemeralMessageTextRequest))]
[JsonSerializable(typeof(EditEphemeralMessageMediaRequest))]
[JsonSerializable(typeof(EditEphemeralMessageCaptionRequest))]
[JsonSerializable(typeof(EditEphemeralMessageReplyMarkupRequest))]
...
[JsonSerializable(typeof(DeleteEphemeralMessageRequest))]
[JsonSerializable(typeof(DeleteMessageReactionRequest))]
[JsonSerializable(typeof(DeleteAllMessageReactionsRequest))]
...
[JsonSerializable(typeof(SendRichMessageRequest))]
[JsonSerializable(typeof(SendRichMessageDraftRequest))]
...
[JsonSerializable(typeof(ApiResponse<SentGuestMessage>))]
[JsonSerializable(typeof(ApiResponse<UserChatBoosts>))]
[JsonSerializable(typeof(ApiResponse<BusinessConnection>))]
[JsonSerializable(typeof(ApiResponse<BotAccessSettings>))]
...
[JsonSerializable(typeof(PaidMediaLivePhoto))]
...
[JsonSerializable(typeof(InputMediaLink))]
[JsonSerializable(typeof(InputMediaLivePhoto))]
[JsonSerializable(typeof(InputMediaLocation))]
[JsonSerializable(typeof(InputMediaSticker))]
[JsonSerializable(typeof(InputMediaVenue))]
[JsonSerializable(typeof(InputPaidMediaLivePhoto))]
...
[JsonSerializable(typeof(RichTextBold))]
[JsonSerializable(typeof(RichTextItalic))]
[JsonSerializable(typeof(RichTextUnderline))]
[JsonSerializable(typeof(RichTextStrikethrough))]
[JsonSerializable(typeof(RichTextSpoiler))]
[JsonSerializable(typeof(RichTextDateTime))]
[JsonSerializable(typeof(RichTextTextMention))]
[JsonSerializable(typeof(RichTextSubscript))]
[JsonSerializable(typeof(RichTextSuperscript))]
[JsonSerializable(typeof(RichTextMarked))]
[JsonSerializable(typeof(RichTextCode))]
[JsonSerializable(typeof(RichTextCustomEmoji))]
[JsonSerializable(typeof(RichTextMathematicalExpression))]
[JsonSerializable(typeof(RichTextUrl))]
[JsonSerializable(typeof(RichTextEmailAddress))]
[JsonSerializable(typeof(RichTextPhoneNumber))]
[JsonSerializable(typeof(RichTextBankCardNumber))]
[JsonSerializable(typeof(RichTextMention))]
[JsonSerializable(typeof(RichTextHashtag))]
[JsonSerializable(typeof(RichTextCashtag))]
[JsonSerializable(typeof(RichTextBotCommand))]
[JsonSerializable(typeof(RichTextButton))]
[JsonSerializable(typeof(RichTextAnchor))]
[JsonSerializable(typeof(RichTextAnchorLink))]
[JsonSerializable(typeof(RichTextReference))]
[JsonSerializable(typeof(RichTextReferenceLink))]
[JsonSerializable(typeof(RichBlockTableCell))]
[JsonSerializable(typeof(RichBlockListItem))]
[JsonSerializable(typeof(RichBlockParagraph))]
[JsonSerializable(typeof(RichBlockSectionHeading))]
[JsonSerializable(typeof(RichBlockPreformatted))]
[JsonSerializable(typeof(RichBlockFooter))]
[JsonSerializable(typeof(RichBlockDivider))]
[JsonSerializable(typeof(RichBlockMathematicalExpression))]
[JsonSerializable(typeof(RichBlockAnchor))]
[JsonSerializable(typeof(RichBlockList))]
[JsonSerializable(typeof(RichBlockBlockQuotation))]
[JsonSerializable(typeof(RichBlockExpandableBlockQuotation))]
[JsonSerializable(typeof(RichBlockPullQuotation))]
[JsonSerializable(typeof(RichBlockCollage))]
[JsonSerializable(typeof(RichBlockSlideshow))]
[JsonSerializable(typeof(RichBlockTable))]
[JsonSerializable(typeof(RichBlockDetails))]
[JsonSerializable(typeof(RichBlockMap))]
[JsonSerializable(typeof(RichBlockButtons))]
[JsonSerializable(typeof(RichBlockAnimation))]
[JsonSerializable(typeof(RichBlockAudio))]
[JsonSerializable(typeof(RichBlockDocument))]
[JsonSerializable(typeof(RichBlockPhoto))]
[JsonSerializable(typeof(RichBlockVideo))]
[JsonSerializable(typeof(RichBlockVoiceNote))]
[JsonSerializable(typeof(RichBlockThinking))]
[JsonSerializable(typeof(InputRichBlockListItem))]
[JsonSerializable(typeof(InputRichBlockParagraph))]
[JsonSerializable(typeof(InputRichBlockSectionHeading))]
[JsonSerializable(typeof(InputRichBlockPreformatted))]
[JsonSerializable(typeof(InputRichBlockFooter))]
[JsonSerializable(typeof(InputRichBlockDivider))]
[JsonSerializable(typeof(InputRichBlockMathematicalExpression))]
[JsonSerializable(typeof(InputRichBlockAnchor))]
[JsonSerializable(typeof(InputRichBlockList))]
[JsonSerializable(typeof(InputRichBlockBlockQuotation))]
[JsonSerializable(typeof(InputRichBlockExpandableBlockQuotation))]
[JsonSerializable(typeof(InputRichBlockPullQuotation))]
[JsonSerializable(typeof(InputRichBlockCollage))]
[JsonSerializable(typeof(InputRichBlockSlideshow))]
[JsonSerializable(typeof(InputRichBlockTable))]
[JsonSerializable(typeof(InputRichBlockDetails))]
[JsonSerializable(typeof(InputRichBlockMap))]
[JsonSerializable(typeof(InputRichBlockButtons))]
[JsonSerializable(typeof(InputRichBlockAnimation))]
[JsonSerializable(typeof(InputRichBlockAudio))]
[JsonSerializable(typeof(InputRichBlockDocument))]
[JsonSerializable(typeof(InputRichBlockPhoto))]
[JsonSerializable(typeof(InputRichBlockVideo))]
[JsonSerializable(typeof(InputRichBlockVoiceNote))]
[JsonSerializable(typeof(InputRichBlockThinking))]
...
[JsonSerializable(typeof(InputRichMessageContent))]
