...
namespace Telegram.Bot
{
    ...
    public interface ITelegramBotClient
    {
        ...
        ///     Pass <c>true</c>, if results may be cached on the server side only for the user that sent the
        ...
        ///     confirmed as soon as <see cref="GetUpdatesAsync" /> is called with an offset higher than its
        ///     <see cref="Update.Id" />.
        ...
        ///     List the <see cref="UpdateType" /> of updates you want your bot to receive. See <see cref="UpdateType" /> for a
        ///     complete list of available update types. Specify an empty list to receive all updates regardless of type (default).
        ///     If not specified, the previous setting will be used.
        ///     Please note that this parameter doesn't affect updates created before the call to the
        ///     <see cref="GetUpdatesAsync" />, so unwanted updates may be received for a short period of time.
        /// </param>
        /// <param name="cancellationToken">
        ///     A cancellation token that can be used by other objects or threads to receive notice of
        ///     cancellation.
        ...
        ///     <see cref="DateTime" /> when the user will be unbanned. If user is banned for more than 366
        ///     days or less than 30 seconds from the current time they are considered to be banned forever
        /// </param>
        /// <param name="cancellationToken">
        ///     A cancellation token that can be used by other objects or threads to receive notice of
        ///     cancellation.
        ...
        ///     administrators except other bots. If the chat is a group or a supergroup and no administrators were appointed, only
        ...
        ///     a game for your bot via BotFather and accept the terms.
        ///     Otherwise, you may use links like telegram.me/your_bot?start=XXXX that open your bot with a parameter.
        /// </remarks>
        ...
        /// <param name="untilDate">
        ///     <see cref="DateTime" /> when restrictions will be lifted for the user. If user is restricted
        ...
        /// </summary>
        /// <param name="chatId">
        ///     <see cref="ChatId" /> Unique identifier for the target chat or username of the target channel (in
        ...
        /// <summary>
        ///     Use this method to reply to shipping queries with success and shipping options. If you sent an invoice requesting a
        ///     shipping address and the parameter is_flexible was specified, the Bot API will send an Update with a shipping_query
        ///     field to the bot.
        /// </summary>
