...
public static partial class TelegramBotClientExtensions
{
    ...
    public static async Task UnpinAllChatMessages(
        ...
        await botClient.ThrowIfNull().
            MakeRequestAsync(
                new UnpinAllChatMessagesRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task LeaveChatAsync(
        ...
        await botClient.ThrowIfNull().
            MakeRequestAsync(
                new LeaveChatRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task<ChatMember[]> GetChatAdministratorsAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new GetChatAdministratorsRequest { ChatId = chatId },
    ...
    public static async Task<int> GetChatMemberCountAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new GetChatMemberCountRequest { ChatId = chatId },
    ...
    public static async Task DeleteChatStickerSetAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new DeleteChatStickerSetRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task CloseGeneralForumTopicAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new CloseGeneralForumTopicRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task ReopenGeneralForumTopicAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new ReopenGeneralForumTopicRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task HideGeneralForumTopicAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new HideGeneralForumTopicRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task UnhideGeneralForumTopicAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new UnhideGeneralForumTopicRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task UnpinAllGeneralForumTopicMessagesAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new UnpinAllGeneralForumTopicMessagesRequest { ChatId = chatId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task<UserChatBoosts> GetUserChatBoostsAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new GetUserChatBoostsRequest { ChatId = chatId, UserId = userId },
    ...
    public static async Task DeleteMessageAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new DeleteMessageRequest { ChatId = chatId, MessageId = messageId },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    ...
    public static async Task<StickerSet> GetStickerSetAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new GetStickerSetRequest { Name = name },
    ...
    public static async Task DeleteStickerSetAsync(
        ...
        await botClient.ThrowIfNull()
            .MakeRequestAsync(
                new DeleteStickerSetRequest { Name = name },
                TelegramBotClientJsonSerializerContext.Instance.ApiResponseBoolean,
                cancellationToken)
            .ConfigureAwait(false);
    #endregion
