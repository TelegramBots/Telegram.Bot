...
public enum InputRichBlockType
{
    ...
    Thinking,
    /// <summary>A block quotation, corresponding to the HTML tag <c>&lt;blockquote&gt;</c> with custom attribute <c>"expandable"</c>.<br/><br/><i>(<see cref="InputRichBlock"/> can be cast into <see cref="InputRichBlockExpandableBlockQuotation"/>)</i></summary>
