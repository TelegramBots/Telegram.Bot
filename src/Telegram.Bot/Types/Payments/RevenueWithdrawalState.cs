...
/// <summary>
/// This object describes the state of a revenue withdrawal operation. Currently, it can be one of<br/><see cref="RevenueWithdrawalStatePending"/>, <see cref="RevenueWithdrawalStateSucceeded"/>, <see cref="RevenueWithdrawalStateFailed"/>
/// </summary>
...
{
    /// <summary>
    /// Type of the state, always <see cref="RevenueWithdrawalState"/>
    /// </summary>
...
{
    /// <summary>
    /// Type of the state, always <see cref="RevenueWithdrawalStateType.Pending"/>
    /// </summary>
...
{
    /// <summary>
    /// Type of the state, always <see cref="RevenueWithdrawalStateType.Succeeded"/>
    /// </summary>
...
{
    /// <summary>
    /// Type of the state, always <see cref="RevenueWithdrawalStateType.Failed"/>
    /// </summary>
