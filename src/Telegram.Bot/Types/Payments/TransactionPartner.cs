...
/// <summary>
/// This object describes the source of a transaction, or its recipient for outgoing transactions. Currently, it can be one of<br/><see cref="TransactionPartnerFragment"/>, <see cref="TransactionPartnerUser"/>, <see cref="TransactionPartnerOther"/>
/// </summary>
...
{
    /// <summary>
    /// Type of the transaction partner, always <see cref="TransactionPartner"/>
    /// </summary>
...
{
    /// <summary>
    /// Type of the transaction partner, always <see cref="TransactionPartnerType.Fragment"/>
    /// </summary>
...
{
    /// <summary>
    /// Type of the transaction partner, always <see cref="TransactionPartnerType.User"/>
    /// </summary>
...
{
    /// <summary>
    /// Type of the transaction partner, always <see cref="TransactionPartnerType.Other"/>
    /// </summary>
