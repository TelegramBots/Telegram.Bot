...
public partial class InputSticker
{
    ...
    /// <summary>
    /// Format of the added sticker, must be one of <see cref="StickerFormat.Static">Static</see> for a <b>.WEBP</b> or <b>.PNG</b> image, <see cref="StickerFormat.Animated">Animated</see> for a <b>.TGS</b> animation, <see cref="StickerFormat.Video">Video</see> for a <b>WEBM</b> video
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.Never)]
