...
{
    /// <summary>
    /// Represents the content of an invoice message to be sent as the result of an <see cref="InlineQuery">inline query</see>.
    /// </summary>
    ...
    public class InputInvoiceMessageContent : InputMessageContent
    {
        ...
        /// <summary>
        /// Optional. An array of suggested amounts of tip in the smallest units of the currency (integer, not float/double). At most 4 suggested tip amounts can be specified. The suggested tip amounts must be positive, passed in a strictly increased order and must not exceed <see cref="MaxTipAmount"/>.
        /// </summary>
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        public InputInvoiceMessageContent(string title,
                                          string description,
                                          string payload,
