...
namespace Telegram.Bot.Types.ReplyMarkups
{
    ...
    public class InlineKeyboardButton : IKeyboardButton
    {
        ...
        /// that chat and insert the bot's username and the specified <see cref="InlineQuery"/>
        ...
        /// switchPm[...] parameters (see <see cref="AnswerInlineQueryRequest"/>)
        ...
        /// </summary>
        /// <remarks>
        /// Note: This offers a quick way for the user to open your bot in inline mode in the
        ...
        /// <summary>
        /// Creates an inline keyboard button that opens a HTTP URL to automatically
        /// authorize the user
        /// </summary>
        /// <param name="text">Label text on the button</param>
        ...
        /// <summary>
        /// Creates an inline keyboard button that sends <see cref="CallbackQuery"/> to
        /// bot when pressed
        /// </summary>
        /// <param name="textAndCallbackData">
        /// Text of the button and data to be sent in a <see cref="CallbackQuery"/> to the bot
        ...
        /// <summary>
        /// Creates an inline keyboard button that sends <see cref="CallbackQuery"/> to bot
        /// when pressed
        /// </summary>
        /// <param name="text">Label text on the button</param>
        /// <param name="callbackData">
        /// Data to be sent in a <see cref="CallbackQuery"/> to the bot when button is pressed,
        /// 1-64 bytes
        /// </param>
        ...
        /// <summary>
        /// Creates an inline keyboard button. Pressing the button will prompt the user to select
        /// one of their chats, open that chat and insert the bot's username and the specified
        /// inline query in the input field.
        /// </summary>
        /// <param name="text">Label text on the button</param>
        /// <param name="query">
        /// Inline query that appears in the input field. Can be empty, in which case just the
        ...
        /// <summary>
        /// Creates an inline keyboard button. Pressing the button will insert the bot's username
        /// and the specified inline query in the current chat's input field.
        /// </summary>
        /// <param name="text">Label text on the button</param>
        /// <param name="query">
        /// Inline query that appears in the input field. Can be empty, in which case just the
        /// bot's username will be inserted.</param>
        ...
        /// <see cref="InlineKeyboardButton"/> with callback data
        /// </summary>
        /// <param name="textAndCallbackData">Label text and callback data of the button</param>
        /// <returns>
        /// The result of the conversion.
        /// </returns>
        [return: NotNullIfNotNull("textAndCallbackData")]
