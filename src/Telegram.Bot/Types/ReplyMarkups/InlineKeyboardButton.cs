...
public partial class InlineKeyboardButton : IKeyboardButton
{
    ...
    public static InlineKeyboardButton WithUrl(string text, string url, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { Url = url, IconCustomEmojiId = iconCustomEmojiId, Style = style };
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithCallbackData(string text, string callbackData, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { CallbackData = callbackData, IconCustomEmojiId = iconCustomEmojiId, Style = style };
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithWebApp(string text, WebAppInfo webApp, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithLoginUrl(string text, LoginUrl loginUrl, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { LoginUrl = loginUrl, IconCustomEmojiId = iconCustomEmojiId, Style = style };
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithSwitchInlineQuery(string text, string switchInlineQuery = "", string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { SwitchInlineQuery = switchInlineQuery, IconCustomEmojiId = iconCustomEmojiId, Style = style };
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithSwitchInlineQueryCurrentChat(string text, string switchInlineQueryCurrentChat = "", string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { SwitchInlineQueryCurrentChat = switchInlineQueryCurrentChat, IconCustomEmojiId = iconCustomEmojiId, Style = style };
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithSwitchInlineQueryChosenChat(string text, SwitchInlineQueryChosenChat switchInlineQueryChosenChat, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { SwitchInlineQueryChosenChat = switchInlineQueryChosenChat, IconCustomEmojiId = iconCustomEmojiId, Style = style };
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithCopyText(string text, CopyTextButton copyText, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { CopyText = copyText, IconCustomEmojiId = iconCustomEmojiId, Style = style };
    ...
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithCallbackGame(string text, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { CallbackGame = new(), IconCustomEmojiId = iconCustomEmojiId, Style = style };

    /// <summary>Creates an inline keyboard button <a href="https://core.telegram.org/bots/api#payments">Pay button</a>. Substrings “⭐” and “XTR” in the buttons's text will be replaced with a Telegram Star icon.<br/><br/><b>NOTE:</b> This type of button <b>must</b> always be the first button in the first row and can only be used in invoice messages.</summary>
    /// <param name="text">Label text on the button</param>
    /// <param name="iconCustomEmojiId"><em>Optional</em>. Unique identifier of the custom emoji shown before the text of the button. Can only be used by bots that purchased additional usernames on <a href="https://fragment.com">Fragment</a> or in the messages directly sent by the bot to private, group and supergroup chats if the owner of the bot has a Telegram Premium subscription.</param>
    /// <param name="style"><em>Optional</em>. Style of the button. Must be one of <see cref="KeyboardButtonStyle.Danger">Danger</see> (red), <see cref="KeyboardButtonStyle.Success">Success</see> (green) or <see cref="KeyboardButtonStyle.Primary">Primary</see> (blue). If omitted, then an app-specific style is used.</param>
    public static InlineKeyboardButton WithPay(string text, string? iconCustomEmojiId = default, KeyboardButtonStyle? style = default) =>
        new(text) { Pay = true, IconCustomEmojiId = iconCustomEmojiId, Style = style };
}
