...
namespace Telegram.Bot
{
    public static partial class PassportEnums
    {
        ...
        public static class Scope
        {
            ...
            /// <summary>
            /// Special type "id_document" is an alias for one of "passport", "driver_license",
            /// or "identity_card"
            /// </summary>
            public const string IdDocument = "id_document";

            /// <summary>
            /// Special type "address_document" is an alias for one of "utility_bill",
            /// "bank_statement", or "rental_agreement"
            /// </summary>
