...
/// <remarks><b>NOTE:</b> After the user presses a callback button, Telegram clients will display a progress bar until you call <see cref="TelegramBotClientExtensions.AnswerCallbackQueryAsync">AnswerCallbackQuery</see>. It is, therefore, necessary to react by calling <see cref="TelegramBotClientExtensions.AnswerCallbackQueryAsync">AnswerCallbackQuery</see> even if no notification to the user is needed (e.g., without specifying any of the optional parameters).</remarks>
