...
/// <summary>This object represents the content of a media message to be sent. It should be one of<br/><see cref="InputMediaAnimation"/>, <see cref="InputMediaAudio"/>, <see cref="InputMediaDocument"/>, <see cref="InputMediaLivePhoto"/>, <see cref="InputMediaPhoto"/>, <see cref="InputMediaVideo"/></summary>
...
public partial class InputMediaAnimation : InputMedia, IInputMediaThumb, IInputMediaSettings, IInputRichMedia, InputPollMedia, InputPollOptionMedia
{
...
/// <summary>Represents a live photo to be sent.</summary>
public partial class InputMediaLivePhoto : InputMedia, IInputMediaSettings, IAlbumInputMedia, InputPollMedia, InputPollOptionMedia
{
    /// <summary>Type of the media, always <see cref="InputMediaType.LivePhoto"/></summary>
    ...
    /// <summary><em>Optional</em>. Pass <see langword="true"/> if the live photo needs to be covered with a spoiler animation</summary>
    [JsonPropertyName("has_spoiler")]
    public bool HasSpoiler { get; set; }

    /// <summary>Initializes an instance of <see cref="InputMediaLivePhoto"/></summary>
    /// <param name="media">File to send. Pass a FileId to send a file that exists on the Telegram servers (recommended), pass an HTTP URL for Telegram to get a file from the Internet, or use <see cref="InputFileStream(Stream, string?)"/> with a specific filename. <a href="https://core.telegram.org/bots/api#sending-files">More information on Sending Files »</a></param>
    /// <param name="photo">The static photo to send. Pass a FileId to send a file that exists on the Telegram servers (recommended) or use <see cref="InputFileStream(Stream, string?)"/> with a specific filename. <a href="https://core.telegram.org/bots/api#sending-files">More information on Sending Files »</a>. Sending live photos by a URL is currently unsupported.</param>
    [SetsRequiredMembers]
    public InputMediaLivePhoto(InputFile media, InputFile photo) : base(media) => Photo = photo;

    /// <summary>Instantiates a new <see cref="InputMediaLivePhoto"/></summary>
    public InputMediaLivePhoto() { }
}

/// <summary>Represents a photo to be sent.</summary>
public partial class InputMediaPhoto : InputMedia, IInputMediaSettings, IAlbumInputMedia, IInputRichMedia, InputPollMedia, InputPollOptionMedia
{
...
public partial class InputMediaVideo : InputMedia, IInputMediaThumb, IInputMediaSettings, IAlbumInputMedia, IInputRichMedia, InputPollMedia, InputPollOptionMedia
{
